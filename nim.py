...
class NimState:
    ...
    def __init__(self, ch):
        # At the root pretend the player just moved is p2, so p1 can have the first move
    ...
    def GetResult(self, playerjm):   # jm: just moved
...
class Node:
    ...
    def TreeToString(self, indent):
        s = self.IndentString(indent) + str(self)   # str(self) will call __repr__ to print the inner states
